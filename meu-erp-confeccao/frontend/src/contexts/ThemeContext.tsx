...
type ThemeMode = 'light' | 'dark' | 'warm' | 'ocean' | 'nature' | 'sunset' | 'lavender' | 'monochrome' | 'cyberpunk' | 'brutalism';
...
export const ThemeProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  const [mode, setMode] = useState<ThemeMode>(() => {
    ...
    const validModes: ThemeMode[] = ['light', 'dark', 'warm', 'ocean', 'nature', 'sunset', 'lavender', 'monochrome', 'cyberpunk', 'brutalism'];
